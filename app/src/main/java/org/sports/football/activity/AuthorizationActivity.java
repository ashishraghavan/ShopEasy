...
public class AuthorizationActivity extends AppCompatActivity implements AuthorizationDelegate.OAuthCallback,View.OnClickListener {
    ...
    public void onAuthorizationSucceeded(AuthToken authToken) {
        ...
        final Intent intent = new Intent(this,Football.class);
